...
import { AlertTriangle, Lock, Trash2, X, AlertCircle, Building2 } from 'lucide-react'
...
function DeleteCompany() {
  ...
  // Company model only has userId, no name field
  ...
  const handleDeleteCompany = async (e) => {
    ...
    if (password === requiredPassword) {
      try {
        ...
        setError('No se pudo eliminar la empresa: ' + err.message)
      } finally {
        setLoading(false)
      }
    } else {
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-2xl">Eliminar Empresa</CardTitle>
          ...
          <div className="p-4 rounded-lg bg-destructive/10 border border-destructive/20">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1 text-sm">
                <p className="font-semibold text-destructive">¿Estás seguro de que deseas eliminar esta empresa?</p>
                <p className="text-muted-foreground">
                  Esta empresa y todos sus datos asociados (clientes, pozos y reportes) serán eliminados permanentemente.
                </p>
              </div>
            </div>
          </div>
