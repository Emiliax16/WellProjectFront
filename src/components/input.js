...
const Input = ({ name, label, type, placeholder, register, validation, classNameLabel, classNameInput, errors }) => {
    ...
    <div className="flex flex-col col-span-full">
      ...
      <div className="mt-2">
        <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
          <input type={type} className={classNameInput} placeholder={placeholder} {...register(label, validation)} />
        </div>
